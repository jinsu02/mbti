export const questions = [ //대괄호 배열데이터 //export question,results,mbtis같은 변수를 내보내기 할 수 있는 JS키워드, 각각의 변수의 데이터를 또다른 JS로 가져가서 활용할 수 있다.
  { //중괄호 객체데이터 / 배열데이터 안에 각각의 객체데이터가 들어있다.
    number: '01',
...
export const mbtis = { //위에 나열된 결과를 여기서 출력
  entj: 0,
  entp: 0,
  estp: 0,
  esfp: 1,
